...
def parser_train():
    ...
    parser.add_argument('--data-dir', type=str, default='/home/ubuntu/adversarial_robustness_pytorch/data/')
    parser.add_argument('--log-dir', type=str, default='/home/ubuntu/adversarial_robustness_pytorch/logs/')
    ...
    parser.add_argument('--aux-data-filename', type=str, help='Path to additional Tiny Images data.', 
                        default='/home/ubuntu/adversarial_robustness_pytorch/ti_500K_pseudo_labeled.pickle')
